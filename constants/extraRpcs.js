...
const privacyStatement = {
  ...
  drpc:
    "The specific types of technical data we may log include: IP address (only for redirecting requests to closest RPC nodes and rate limiting on free tier).https://drpc.org/privacy-policy",
  las:
